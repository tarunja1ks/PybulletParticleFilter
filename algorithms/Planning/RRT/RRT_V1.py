...
# (RRT) | Status: COMPLETED (Version 1: Unbiased sampling)
...
class RRT():
    ...
    def isCollide(self, startNode, endPoint, obstacleList, gridMapObj, robotRadius):
        ...
        for alpha in np.arange(res, 1+res, res)[::-1]:
...
def main(gridMapFile, start, goal, epsilon, robotRadius):
    """
    ...
    # Import a grid map
    gridMap = RRT.GridMap(gridMapFile, 5.0, 5.0, 50, 0.1)
...
if __name__ == '__main__':
    ...
    """
    # Set start and goal
    startPoint, goalPoint = (-1.5, -1.9), (1.7, 1.7)
    ...
    main(gridMapFile, startPoint, goalPoint, epsilon, robotRadius)
